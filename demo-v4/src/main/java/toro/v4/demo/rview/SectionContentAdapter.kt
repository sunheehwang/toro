 ...
 */
class SectionContentAdapter(val listener: VideoViewHolder.ClickListener) : Adapter<BaseViewHolder>() {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
    ...
    return if (viewType == typeVideo) VideoViewHolder(inflater!!, parent, this.listener)
